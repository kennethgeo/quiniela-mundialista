          ...
          <div className="space-y-4 relative z-10">
            ...
            <div className="bg-slate-50 dark:bg-white/[0.02] p-5 rounded-2xl border border-slate-100 dark:border-white/5 flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 mt-2 leading-relaxed">
                  Si predices un empate (Ej. 1-1), el sistema te pedirá automáticamente que elijas quién avanzará ganando en la tanda de penales. Este pronóstico también forma parte de la predicción y puede definir si recibes puntos o no.
                </p>
              </div>
            </div>
          </div>
