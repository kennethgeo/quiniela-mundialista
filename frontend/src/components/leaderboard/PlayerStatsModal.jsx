    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-md bg-white dark:bg-[#0C0C0C] rounded-[20px] border border-slate-200 dark:border-[#262626] shadow-[0_20px_50px_-20px_rgba(0,0,0,0.6)] overflow-hidden max-h-[88vh] flex flex-col"
        >
