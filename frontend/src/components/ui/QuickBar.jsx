// Barra superior mínima (solo móvil): logo + switch de tema + forzar actualización.
...
// Fuerza traer la última versión: actualiza el service worker, limpia cachés y recarga.
  ...
  return (
    <div className="md:hidden sticky top-0 z-30 flex items-center justify-between px-4 pt-[max(0.45rem,env(safe-area-inset-top))] pb-2 bg-[var(--bg-body)]/85 backdrop-blur-md">
      ...
      <div className="flex items-center gap-2">
        ...
        <button onClick={() => { setBusy(true); forceUpdate() }} className={btn} title="Forzar actualización" aria-label="Forzar actualización">
