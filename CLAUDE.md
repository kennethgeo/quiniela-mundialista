...
- Se pregunta en **`/auth/v1/settings`**, que es público y devuelve `{ external: { google: true|false … } }`. Así el botón **aparece solo** el día que se habilite, sin desplegar nada ni tocar una bandera; y si se apaga, desaparece.
