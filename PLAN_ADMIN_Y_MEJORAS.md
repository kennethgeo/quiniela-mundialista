...
| B59 🔶 | **Quien propuso, votó o confirmó pagos no se puede borrar** (95/96). Hace falta un flujo de **anonimizar/desactivar** que conserve la identidad histórica sin dejar la cuenta con acceso; recomendado también por la undécima auditoría. Antes: **Quien propuso o votó no se puede borrar** (95: FK `RESTRICT` como protección inmediata). El arreglo de fondo es separar la identidad histórica del autor/votante de la cuenta borrable, como el historial de pagos | `95_…`, `delete-user` | diseño pendiente |
